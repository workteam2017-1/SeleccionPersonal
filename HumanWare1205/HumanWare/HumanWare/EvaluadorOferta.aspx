<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EvaluadorOferta.aspx.cs" Inherits="HumanWare.HumanWare.EvaluadorOferta1" %>
...
<br/>
   <table border="1" width="70%" cellspacing="3" bgcolor="white" bordercolor="black">
        ...
        <asp:PlaceHolder ID="CandidatosPlaceHolder" runat="server"></asp:PlaceHolder>
<%--        <tr>
...
<asp:Button ID="btnExportar" runat="server" Text="Exportar a Excel" OnClick = "btnExportarExcel_Click" />
