...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <td> <asp:TextBox ID="txtNombresAp" runat="server" MaxLength="100" /> </td>
    </tr>
    <tr>
    ...
    <td> <asp:TextBox ID="txtRetribucionMn" runat="server" TextMode="Number"/></td>
    </tr>
    <tr>
    <td><asp:Label Text="Jornada que puede cumplir:" runat="server" /> </td>
    <td><asp:DropDownList ID="ddJornada" runat="server" ToolTip="Seleccione un item"> 
   ...
   <table border="1" width="70%" cellspacing="3" bgcolor="white" bordercolor="black">
    ...
    <asp:Button runat="server" OnClick="OnClickEnviar" ID="o001" Text="Enviar"/>
